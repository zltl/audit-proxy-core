...
static void handle_metrics(hc_conn_t *conn) {
    ...
    int len = snprintf(
        body, sizeof(body),
        "# HELP audit_proxy_up Whether the SSH proxy is up (1 = up).\n"
        "# TYPE audit_proxy_up gauge\n"
        "audit_proxy_up 1\n"
        "# HELP audit_proxy_uptime_seconds Time since process start.\n"
        "# TYPE audit_proxy_uptime_seconds gauge\n"
        "audit_proxy_uptime_seconds %ld\n"
        "# HELP audit_proxy_connections_total Total accepted connections.\n"
        "# TYPE audit_proxy_connections_total counter\n"
        "audit_proxy_connections_total %" PRIuFAST64 "\n"
        "# HELP audit_proxy_connections_active Current active connections.\n"
        "# TYPE audit_proxy_connections_active gauge\n"
        "audit_proxy_connections_active %" PRIuFAST64 "\n"
        "# HELP audit_proxy_auth_success_total Successful authentications.\n"
        "# TYPE audit_proxy_auth_success_total counter\n"
        "audit_proxy_auth_success_total %" PRIuFAST64 "\n"
        "# HELP audit_proxy_auth_failure_total Failed authentications.\n"
        "# TYPE audit_proxy_auth_failure_total counter\n"
        "audit_proxy_auth_failure_total %" PRIuFAST64 "\n"
        "# HELP audit_proxy_bytes_upstream_total Bytes sent to upstream.\n"
        "# TYPE audit_proxy_bytes_upstream_total counter\n"
        "audit_proxy_bytes_upstream_total %" PRIuFAST64 "\n"
        "# HELP audit_proxy_bytes_downstream_total Bytes sent to client.\n"
        "# TYPE audit_proxy_bytes_downstream_total counter\n"
        "audit_proxy_bytes_downstream_total %" PRIuFAST64 "\n"
        "# HELP audit_proxy_sessions_rejected_total Sessions rejected by filters.\n"
        "# TYPE audit_proxy_sessions_rejected_total counter\n"
        "audit_proxy_sessions_rejected_total %" PRIuFAST64 "\n"
        "# HELP audit_proxy_config_reloads_total Successful config reloads.\n"
        "# TYPE audit_proxy_config_reloads_total counter\n"
        "audit_proxy_config_reloads_total %" PRIuFAST64 "\n"
        "# HELP audit_proxy_config_reload_errors_total Failed config reloads.\n"
        "# TYPE audit_proxy_config_reload_errors_total counter\n"
        "audit_proxy_config_reload_errors_total %" PRIuFAST64 "\n"
        "# HELP audit_proxy_upstream_retries_total Total upstream connection retry attempts.\n"
        "# TYPE audit_proxy_upstream_retries_total counter\n"
        "audit_proxy_upstream_retries_total %" PRIuFAST64 "\n"
        "# HELP audit_proxy_upstream_retries_success Successful connections after retry.\n"
        "# TYPE audit_proxy_upstream_retries_success counter\n"
        "audit_proxy_upstream_retries_success %" PRIuFAST64 "\n"
        "# HELP audit_proxy_upstream_retries_exhausted Connections where all retries were "
        "exhausted.\n"
        "# TYPE audit_proxy_upstream_retries_exhausted counter\n"
        "audit_proxy_upstream_retries_exhausted %" PRIuFAST64 "\n",
