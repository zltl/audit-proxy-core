...
func TestClientConfigFromEnv(t *testing.T) {
	t.Setenv("AUDITPROXY_SERVER", "https://test.example.com:8443")
	t.Setenv("AUDITPROXY_TOKEN", "test-token-123")
...
func TestClientConfigEnvOverridesFile(t *testing.T) {
	...
	t.Setenv("AUDITPROXY_SERVER", "https://env-server.example.com")
	t.Setenv("AUDITPROXY_TOKEN", "env-token")
