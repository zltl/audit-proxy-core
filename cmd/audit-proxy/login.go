...
func runLogin(args []string) {
	...
	cfg := loadConfig()
	if cfg.Server == "" {
		printError("missing control-plane server; set server in ~/.audit-proxy/config.json or AUDITPROXY_SERVER")
		os.Exit(1)
	}
...
func defaultIdentityPath() string {
	...
	if err != nil {
		return ".audit-proxy/id_ed25519"
	}
	return filepath.Join(home, ".audit-proxy", "id_ed25519")
}
